  ...
  return (
    <div className="bg-white">
      ...
      <div className="flex flex-col items-center  md:items-start md:w-1/2 mb-8 md:mb-0">
        ...
        <button className="max-w-[400px] w-full md:w-full bg-white border border-gray-700 text-gray-700 p-3
         rounded-full mb-4">
          Sign in with email
        </button>
      ...
      <div className="flex justify-center md:w-1/2 mb-8 md:mb-0 mt-20">
        <img src={Hero} alt="Hero Learning Image" className="w-full md:w-11/12" />
      </div>
    </div>
    </div>
  );
